...
public class RecyclerViewAdapterListMetiersClient extends RecyclerView.Adapter<RecyclerViewAdapterListMetiersClient.ListMetiersViewHolder> {
    ...
    public RecyclerViewAdapterListMetiersClient(ArrayList<Metiers> metiers) {
    ...
    public void onBindViewHolder(@NonNull ListMetiersViewHolder holder, int position) {
        ...
        holder.logoMetier.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), ActivityListOuvrierClient.class);
