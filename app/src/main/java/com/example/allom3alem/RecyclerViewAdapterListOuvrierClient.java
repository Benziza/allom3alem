...
public class RecyclerViewAdapterListOuvrierClient extends  RecyclerView.Adapter<RecyclerViewAdapterListOuvrierClient.ListOuvrierViewHolder>{

    ArrayList<Ouvrier> ouvriers;
    MyDataBase db;
    ArrayList<Ouvrier> dbListOuvrier = new ArrayList<>();

    public RecyclerViewAdapterListOuvrierClient(ArrayList<Ouvrier> ouvriers) {
            ...
            public void onClick(View v) {
                ...
                for(int i=0;i<dbListOuvrier.size();i++)
                {
                    if(dbListOuvrier.get(i).getNOM().equals(o.getNOM()))
                    {
                        ...
                        Intent intent = new Intent(v.getContext(), ActivityModeClientPorfilOuvrier.class);
